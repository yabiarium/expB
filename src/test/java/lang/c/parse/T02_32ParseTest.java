...
public class T02_32ParseTest {

    public static class factorAmpTest {
        ParseTestHelper<FactorAmp> factorAmpHelper = new ParseTestHelper<FactorAmp>(FactorAmp.class);
        ...
        public void trueESTest() throws FatalErrorException {
            ...
            factorAmpHelper.parseAcceptTestList(testDataArr);
        }
